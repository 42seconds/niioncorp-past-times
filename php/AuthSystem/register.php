...
<head>
  ...
  <style>
    ...
    .container { max-width: 520px; margin: 60px auto; background: #fff; border-radius: 16px; padding: 40px; box-shadow: 0 4px 24px rgba(0,0,0,0.10); border: 1px solid var(--border); }
    ...
    .pending-notice { background: #fff3e0; border: 1px solid #ffe0b2; border-radius: 8px; padding: 12px 16px; font-size: 13px; color: #7a4f00; margin-top: 16px; }
  </style>
</head>
<body>

<div style="text-align:center; padding:24px 0 0;">
  <a href="../html/past-times.html" style="font-family:var(--font-display);font-size:22px;font-weight:700;color:var(--primary);text-decoration:none;">Past Times</a>
</div>
...
<div class="container">
  ...
  <?php else: ?>
    ...
    <form method="POST" action="../php/AuthSystem/register.php" novalidate>

      <div class="input-row">
        <div class="form-group">
          <label class="form-label" for="firstName">First Name</label>
          <input class="form-input" type="text" id="firstName" name="firstName"
            value="<?= $sFirst ?>" placeholder="John" required minlength="2" title="Enter your first name">
        </div>
        <div class="form-group">
          <label class="form-label" for="lastName">Last Name</label>
          <input class="form-input" type="text" id="lastName" name="lastName"
            value="<?= $sLast ?>" placeholder="Doe" required minlength="2" title="Enter your last name">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <input class="form-input" type="text" id="username" name="username"
          ...
          pattern="[a-zA-Z0-9_]+" title="Username: letters, numbers, underscores only (min 3 chars)">
      </div>

      <div class="form-group">
        <label class="form-label" for="email">Email Address</label>
        <input class="form-input" type="email" id="email" name="email"
          value="<?= $sEmail ?>" placeholder="john.doe@example.com" required title="Enter a valid email address">
      </div>

      <div class="form-group">
        <label class="form-label" for="password">Password</label>
        <input class="form-input" type="password" id="password" name="password"
          placeholder="Choose a password" required minlength="4" title="Minimum 4 characters">
        <div style="font-size:11px;color:var(--text-muted);margin-top:4px;">🔒 Stored securely as an MD5 hash</div>
      </div>

      <div class="form-group">
        <label class="form-label" for="confirm">Confirm Password</label>
        <input class="form-input" type="password" id="confirm" name="confirm"
          placeholder="Repeat your password" required minlength="4" title="Must match the password above"
          oninput="checkMatch()">
    ...
    <div class="links">Already have an account? <a href="../php/AuthSystem/login.php">Log In</a></div>
...
function checkMatch() {
  ...
  if (pw === c) { msg.style.color = 'green'; msg.textContent = '✔ Passwords match'; }
