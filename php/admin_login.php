...
<div style="text-align:center; padding:24px 0;">
  <a href="../html/past-times.html" style="font-size:22px;font-weight:700;color:var(--primary);text-decoration:none;">
    Past Times
  </a>
</div>
...
<div class="subtitle">Sign in to manage the system.</div>
  ...
  <form method="POST" action="../php/AdminSystem/admin_login.php">
